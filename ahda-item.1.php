...
<!--Archival digitized item/image-->  
     <div class="container px-1" style="background-color:rgba(245, 253, 240);">
       <div class="row align-items-center py-2" style="min-height: 95vh">
          <div class="col-6 pt-5 pb-3">
            <img src="/ahda_assets/img-archive/MP-8.jpg" class="img-thumbnail" alt="ahda-01.front-image" style="width: 610px; height:auto;">
            <img src="/ahda_assets/img-archive/MP_9.jpg" class="img-thumbnail" alt="ahda-01.back-image"style="width: 610px; height:auto;">    
         </div>
<!--End of Archival digitized item/image--> 
