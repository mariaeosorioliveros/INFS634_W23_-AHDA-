...
<div class="container-fluid pb-1 pt-4 px-5" style="background-color:rgb(255, 255, 255);">
    <h2 style="font-family:Roboto,sans-serif; font-size: 17px; font-weight:700;color: rgb(0, 0, 0);">SUPPLEMENT TO THE CHRONOLOGY OF QUINA DISCOVERY IN SANTAFE, 1789</h2>
</div> 
...
<!--Archival digitized item/pdf-->    
       ...
       <div class="col-md-6 d-flex flex-column ps-4 center">
              ...
              $stmt= $conn->query("SELECT `Title`, `Creator`, `Date` ,`Description`,`Subject`,`Keywords`,`Institution holding the item`,`Reference number`,`Permanent URL` FROM `Item List` WHERE `ID_item`=2");
              $data= $stmt->fetchALL(PDO::FETCH_ASSOC);
              ?>
          <div class="card" style="width: 600px">
            <div class="card-header" style="background-color:rgb(229, 250, 225);">
               <a href="ahda-Archive.php" class="card-link">Browse archive<i class="bi bi-chevron-double-right" style="font-size: 16px;"></i>Quina Collection<i class="bi bi-chevron-double-right" style="font-size: 16px;"></i>Supplement to Quina Chronology</a>
            </div>
          <div class="card-header fw-bolder" style="background-color: rgb(230, 241, 201);">
               <strong>AHDA-02</strong>
         </div>
